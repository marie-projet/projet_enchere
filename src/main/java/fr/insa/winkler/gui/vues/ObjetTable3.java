 ...
 * 
 * affiche les objets plus en vente sous forme de table
 */
public class ObjetTable3 extends TableView {
    
    private MainPane main;
    
    private ObservableList<Objet> objets;
    
    public ObjetTable3(MainPane main,List<Objet> objets) {
        this.main = main;
        ...
        TableColumn<Objet,String> cPrix = 
                new TableColumn<>("enchère finale");
